...
public class Verifications {
    ...
    public void repeatableTextIncludedInEachInputListIndex(List<Locator> list, String repeatableText) {
        for (Locator locator : list) {
            assertTrue(locator.getAttribute("value").contains(repeatableText));
        }
    }
...
// Single element verifications
    ...
    public void getAndVerifyCorrectElementText(Locator locator, String expectedText) {
        assertEquals(expectedText, locator.innerText());
    }

    public void getAndVerifyCorrectElementAttributeValue(Locator locator, String attribute, String expectedText) {
        assertEquals(expectedText, locator.getAttribute(attribute));
    }

    public void getAndVerifyElementAttributeContainsSpecificValue(Locator locator, String attribute, String expectedValue) {
        assertTrue(locator.getAttribute(attribute).contains(expectedValue));
    }
